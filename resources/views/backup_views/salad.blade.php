    ...
    <div class="container">
        <div class="row">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ url('/') }}" style="font-family: 'Pacifico'; font-size: 28px; color: #ffffff !important;">Restaurant</a>
            </div>
                    ...
                    <li>
                        <a class="color_animation" href="{{ url('/cart') }}" style="position: relative;">
                            ...
                            @if(session('cart') && count(session('cart')) > 0)
                                <span class="badge" style="background-color: #e74c3c; position: absolute; top: 5px; right: -5px; font-size: 10px;">
                                    {{ count(session('cart')) }}
                                </span>
                            @endif
                        </a>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" style="background: #222; border-top: 3px solid #e74c3c;">
                                @if(Auth::user()->role == 'admin')
                                    <li><a href="{{ url('/admin') }}" style="color: #fff !important; padding: 10px;">Quản trị viên</a></li>
                                @endif
                                <li><a href="{{ url('/profile') }}" style="color: #fff !important; padding: 10px;">Hồ sơ của tôi</a></li>
                                <li role="separator" class="divider" style="background-color: #444;"></li>
                                <li>
                                    <a href="#" style="color: #fff !important; padding: 10px;"
