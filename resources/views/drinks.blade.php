...
<div class="container">
    ...
    <div class="row">
        <div class="col-xs-12">
            <h1 class="section-title">Thực Đơn Đồ Uống</h1>
            <p class="section-subtitle">
                Thưởng thức những loại đồ uống tươi mát, từ nước ép trái cây đến cocktail đặc biệt, mang lại trải nghiệm hoàn hảo cho bữa ăn của bạn.
            </p>
        </div>
    </div>
