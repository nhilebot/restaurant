...
@section('title', 'Thực đơn Món Việt - Restaurant')
...
<style>
    ...
    /* NHÃN TRANG TRÍ RIÊNG CHO MÓN VIỆT */
    .badge-viet {
        position: absolute;
        top: 10px;
        right: 10px;
...
<div class="container">
    <div class="row">
        <div class="col-xs-12">
            <h1 class="section-title">Món Việt truyền thống</h1>
            <p class="section-subtitle">
                Ẩm thực Việt tại Nhà Hàng mang đến hương vị truyền thống đậm đà, kết hợp tinh tế giữa nguyên liệu tươi ngon và bí quyết chế biến đặc trưng của từng vùng miền.
            </p>
        </div>
    </div>
    ...
    <div class="category-nav">
        ...
        <a href="{{ url('/vietnamese') }}" class="btn-category active">Món Việt</a>
